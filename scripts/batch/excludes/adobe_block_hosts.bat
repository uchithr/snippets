...
IF %ERRORLEVEL% NEQ 0 ECHO %NEWLINE%^	127.0.0.1	genuine.adobe.com>>%WINDIR%\system32\drivers\etc\hosts

FIND /C /I "prod.adobegenuine.com" %WINDIR%\system32\drivers\etc\hosts
IF %ERRORLEVEL% NEQ 0 ECHO %NEWLINE%^	127.0.0.1	prod.adobegenuine.com>>%WINDIR%\system32\drivers\etc\hosts